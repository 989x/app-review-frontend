            ...
            <div class="p-2 max-w-lg">
                ...
                <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div class="p-5">
                        ...
                        <a href="#">
                            <h5 class="mb-2 text-xl font-bold tracking-wide text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-300">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
