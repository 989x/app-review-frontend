            ...
            <div class="p-2 max-w-xs">
                ...
                <div class="bg-white rounded-lg shadow-md">
                    ...
                    <div class="p-5">
                        ...
                        <a href="#">
                            <h5 class="font-['SoleiiBold'] mb-2 text-base font-bold tracking-wide text-gray-900">EVGA RTX 3090 FTW3 Ultra Gaming 24GB GDDR6X</h5>
                        </a>
                        ...
                        <a href="#">
                            <h5 class="font-['SoleiiBold'] mb-2 text-base text-gray-900">How graphics card bundles are both hurting and helping during the GPU shortage</h5>
                        </a>

                        <p class="mb-3 text-sm text-gray-900">GPU bundles have been one of the only ways to buy a graphics card in 2021, and they’ve been met with a mixed . . . </p>
